<div class="acp-page-container">
	...
	<div class="row m-0">
		<div id="spy-container" class="col-12 px-0 mb-4" tabindex="0">
			<div class="alert alert-info">
				...
				<ol>
					<li>
						...
						<a href="https://developers.kakao.com/console/app">API Manager <i class="fa fa-external-link"></i></a>
					</li>
					<li>
						From the "Credentials" page, create a new "OAuth Client ID". (<a data-action="help-credentials" href="{config.relative_path}/plugins/nodebb-plugin-sso-kakao/images/credentials.png"><i class="fa fa-question-circle"></i> Where is this page?</a>)
						<ul>
							...
							<li>
								...
								<ul>
									<li>Our best guess for this site is <code>{baseUrl}/auth/kakao/callback</code></li>
					...
					<li>You can set this values in two ways
						<ul>
							<li>Use environment variables
								<ul>
									<li><code>export SSO_KAKAO_CLIENT_ID='Client ID'</code></li>
									<li><code>export SSO_KAKAO_CLIENT_SECRET='Client Secret'</code></li>
								</ul>
							</li>
			...
			<form role="form" class="sso-kakao-settings">
				<div class="mb-3">
